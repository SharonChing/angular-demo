'use strict';
    ...
    angular.module('app.common').constant("modalConfig", {
        "modalBodyTemplateUrl": "./../templates/common-modal-body.html",
    }).service("ModalService", /*@ngInject*/function ($uibModal, $templateCache, $q, $injector,$$stackedMap) {
